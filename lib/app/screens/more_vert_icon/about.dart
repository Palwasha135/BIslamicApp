...
borderRadius:BorderRadius.only(
  ...
  bottomRight: Radius.circular(100),
      ...
      child:const  Padding(
        ...
        child:  Text('This application that utilizes an attractive approach to teach children the fundamental tenets of Islam. This app covers topics such as daily supplications, the Pillars of Islam, and the Seerah of the Prophet (peace be upon him).It is designed to promote Islamic education and values through a fun and engaging learning experience.',style: TextStyle(color: Colors.white, fontSize: 19)),
      )
