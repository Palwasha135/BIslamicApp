...
import 'package:fyp/app/screens/duaslevel2/badnews10.dart';
import 'package:fyp/app/screens/duaslevel2/beforemeal1.dart';
import 'package:fyp/app/screens/duaslevel2/dining5.dart';
import 'package:fyp/app/screens/duaslevel2/drinkingmilk4.dart';
import 'package:fyp/app/screens/duaslevel2/entringtoilet8.dart';
import 'package:fyp/app/screens/duaslevel2/forgetBismillah2.dart';
import 'package:fyp/app/screens/duaslevel2/goingbed6.dart';
import 'package:fyp/app/screens/duaslevel2/leavingtoilet9.dart';
import 'package:fyp/app/screens/duaslevel2/wakingup7.dart';
  ...
  Widget build(BuildContext context) {
    ...
    //  }, icon:const Icon(Icons.next_plan_rounded),iconSize: 38,)
      ...
      children: [
        ...
        Expanded(
          child: Levels(title: ' Before Meal', containercolor: Colors.orange, image: 'assets/images/level2/1.png', onPress: (){
    ...
    Levels(title: ' When Dining Someone`s House ', containercolor: Colors.yellow, image: 'assets/images/level2/5.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const DiningScreen()));
    }) ,Levels(title: ' Before Going To Bed', containercolor: Colors.cyanAccent, image: 'assets/images/level2/6.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const BedduaScreen()));
    }) ,
    Levels(title: ' When Waking Up', containercolor: Colors.deepOrange, image: 'assets/images/level2/7.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const WakingupScreen()));
    }) ,
    Levels(title: '  When Entring The Toilet', containercolor: Colors.pink, image: 'assets/images/level2/8.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const EntringScreen()));
    }) ,
    Levels(title: ' When Leaving The Toilet', containercolor: Colors.deepPurpleAccent, image: 'assets/images/level2/9.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const LeavingScreen()));
    }) ,
    Levels(title: ' When Hear Bad News', containercolor: Colors.yellowAccent, image: 'assets/images/level2/10.png', onPress: (){
