  ...
  Widget build(BuildContext context) {
    ...
    body:Padding(
      padding: const EdgeInsets.only(
        ...
        left:13.0,
        right:13.0,),
      child: GridView(gridDelegate:const  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 0,crossAxisSpacing: 0,),
      children: [
        SeerahGridformScreen(imagepath: 'assets/images/Seerah/wivescontainer.png', onPress: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>const WivesnamesScreen()));
        },
        ),
        SeerahGridformScreen(imagepath: 'assets/images/Seerah/sonscontainer.png', onPress: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>const SonsnamesScreen()));
        },
        ),
        SeerahGridformScreen(imagepath: 'assets/images/Seerah/daughterscontainer.png', onPress: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>const DaughtersnamesScreen()));
        },
        ),
        SeerahGridformScreen(imagepath: 'assets/images/Seerah/unclenamescontainer.png', onPress: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>const UnclenamesScreen()));
        },
        ),
        SeerahGridformScreen(imagepath: 'assets/images/Seerah/auntnamescontainer.png', onPress: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>const AuntnamesScreen()));
        },
        ),
