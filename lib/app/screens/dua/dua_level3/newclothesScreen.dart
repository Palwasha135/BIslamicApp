...
class WearingnewClothesScreen extends StatefulWidget {
  ...
  @override
  State<WearingnewClothesScreen> createState() => _WearingnewClothesScreenState();
}
...
class _WearingnewClothesScreenState extends State<WearingnewClothesScreen> {
  ...
  Expanded(child: Center(child: DuaScreen(assetImagePath: 'assets/images/level3/newclothes.jpg', iconData:Homeicon()))),
