...
class VisitingGraveyardScreen extends StatefulWidget {
  ...
  @override
  State<VisitingGraveyardScreen> createState() => _VisitingGraveyardScreenState();
}
...
class _VisitingGraveyardScreenState extends State<VisitingGraveyardScreen> {
  ...
  Expanded(child: Center(child: DuaScreen(assetImagePath: 'assets/images/level4/visitinggraveyard.jpg', iconData:Homeicon()))),
