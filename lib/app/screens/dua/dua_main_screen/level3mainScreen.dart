...
class _Level3ScreenState extends State<Level3Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    actions:  const [],
      ...
      children: [
        ...
        Expanded(
         ...
         Levels(title: ' Before Undressing ', containercolor: Colors.lightGreenAccent, image: 'assets/images/level3/undressingduaimg.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=> const UndressingDuaScreen()));
    }) ,
    ...
    Levels(title: 'When Seeing Mirror', containercolor: Colors.purpleAccent, image: 'assets/images/level3/mirrorduaimg.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const SeeingmirrorScreen()));
    }) ,
    Levels(title: ' When Entring The House ', containercolor: Colors.red, image: 'assets/images/level3/entringhouseimg.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const EntringhouseScreen()));
    }) ,
    Levels(title: ' When Leaving The House ', containercolor: Colors.orange, image: 'assets/images/level3/4.jpg', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const LeavinghouseScreen ()));
    }) ,
    Levels(title: ' When Entring The Masjid ', containercolor: Colors.yellowAccent, image: 'assets/images/level3/2.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=> const EntringMasjidScreen()));
    }) ,
      
      Levels(title: ' When Leaving The Masjid', containercolor: Colors.blueGrey, image: 'assets/images/level3/3.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const LeavingMasjidScreen()));
    }),
    Levels(title: 'When Doing Wudu ', containercolor: Colors.blueAccent, image: 'assets/images/level3/doingwuduimg.png', onPress: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const DoingWuduScreen()));
     }) ,
    Levels(title: 'After Wudu ', containercolor: Colors.deepOrange, image: 'assets/images/level3/5.png', onPress: (){
